...

{
  ...
  systemd.user.services.rclone-dropbox = {
    ...
    Service = {
      ...
      ExecStart = "${pkgs.rclone}/bin/rclone mount Dropbox: /home/tprice/Documents/Dropbox --vfs-cache-mode full --vfs-cache-max-size 500G --buffer-size 256M --vfs-read-ahead 512M --vfs-read-chunk-size 32M --vfs-read-chunk-size-limit 1G --dir-cache-time 1h --poll-interval 30s --transfers 8";
