...
-- Eric workspace dimensions
eWorkspaceDisplayPrefix = "E"
eWorkspaceKeyPrefix     = Nothing
eDesktops               = 7
eDesktopPanes           = 1
...
eWorkspaces    = workspaceNames eWorkspaceDisplayPrefix eDesktops eDesktopPanes
eWorkspaceKeys = wsKeys eWorkspaceKeyPrefix eWorkspaceDisplayPrefix eDesktops eDesktopPanes

myExtraWorkspaces = ["IM", "MAIL", "SCRATCH", "NSP"]
myWorkspaces      = eWorkspaces ++ myExtraWorkspaces
...
setupWorkspaceGroups = do
    ADWG.addRawWSGroup "Eric1"     [(leftScreen, "E1"), (rightScreen, "E2")]
    ADWG.addRawWSGroup "Eric2"     [(leftScreen, "E3"), (rightScreen, "E4")]
    ADWG.addRawWSGroup "Messaging" [(leftScreen, "IM"), (rightScreen, "MAIL")]

powerkeys :: Int -> X ()
powerkeys key = case key of
    1 -> ADWG.viewWSGroup "Eric1"
    2 -> ADWG.viewWSGroup "Eric2"
...
myCustomKeys =
    ...
    ++ viewGroupKeys "e e" "Eric1"
    ++ viewGroupKeys "e 1" "Eric1"
    ++ viewGroupKeys "e 2" "Eric2"
    ++ viewGroupKeys "c"   "Messaging"

myNewStyleKeys = eWorkspaceKeys ++ myCustomKeys ++ warpMouseKeys
